...
"""
    ...
    A.DIR and exactly one coordinate differs by between 4 and 10. Any given node A is adjacent to at most
    14 other nodes, depending on space. So there are V = 19_881 * 4 vertices in the graph and 
    at most E = V*14 directed edges.
"""
def answer(lines):
    n = len(lines)
    m = len(lines[0])
